<think>我需要为用户创建一个Chrome插件（SmartInterview）的本地使用说明文档。基于我看到的代码和之前的对话，这是一个可以分析简历并生成面试问题的插件。我将包括安装步骤、功能介绍、使用方法和常见问题等内容。</think># Chrome插件 - SmartInterview 本地使用说明文档
